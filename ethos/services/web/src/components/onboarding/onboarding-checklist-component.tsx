...
export function OnboardingChecklist({
  ...
  const connectedProfileAddresses = useConnectedProfileAddresses().data;
  const { data } = useOnboardingStatus(connectedProfileAddresses?.profileId, TARGET_SCORE);
  ...
  const checklistItems = useMemo<OnboardingChecklistItems>(
    () => [
      ...
      },
      {
        ...
        actionLink: routeTo(
          connectedProfileAddresses ? { address: connectedProfileAddresses.primaryAddress } : null,
        ).profile,
      },
    ],
    [data, connectedProfileAddresses, isExtensionInstalled],
  );
