...
import { InsufficientInitialLiquidity, InsufficientFunds, InsufficientVotesOwned, InsufficientVotesToSell, InvalidProfileId, MarketAlreadyExists, MarketCreationErrorCode, MarketCreationUnauthorized, MarketDoesNotExist } from "./errors/ReputationMarketErrors.sol";
...
contract ReputationMarket is AccessControl, UUPSUpgradeable {
  ...
  function simulateBuy(
    ...
    _checkMarketExists(profileId);
    return _calculateBuy(markets[profileId], isPositive, amount, funds);
  }
  ...
  function _calculateBuy(
    ...
    while (fundsAvailable >= votePrice && votesBought < amount) {
